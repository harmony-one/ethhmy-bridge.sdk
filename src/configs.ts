...
export default {
  eth: {
    mainnet: ethMainnetConfig,
    testnet: ethTestnetConfig,
  },
  hmy: {
    mainnet: hmyMainnetConfig,
    testnet: hmyTestnetConfig,
  },
};
